  ...
  <div class="pnl-layout" id="pnlLayout">
    ...
    <aside class="pnl-side">
      <div class="pnl-brand">
        ...
        <div class="pnl-bwrap"><div class="pnl-bname">Portal de Nómina</div><div class="pnl-bver">v6.252</div></div>
...
/* v6.252 — Re-procesa RIF ya guardados con el parser actual.
...
async function viewSync(user) {
  ...
  $('#pnlMain').innerHTML = `
    ...
    <!-- v6.252: re-lee RIF viejos con el parser actual. 89 quedaron sin
